...
namespace Lab3.Controllers
{
    public class CitiesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CityId,ProvinceCode,CityName,Population")] City city)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CityId,ProvinceCode,CityName,Population")] City city)
        {
            if (id != city.CityId)
            {
                return NotFound();
